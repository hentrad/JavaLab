...
public class ArrayOnJavaTest {
    ...
    @Test
    public void testSortArray2() throws LabException {
    ...
    @Test
    public void testSortArray3() throws LabException {
    ...
    @Test
    public void testSortArray4() throws LabException {
        ArrayOnJava ops = new ArrayOnJava(new int[]{});
        ops.sortArray();
    ...
    @Test
    public void testConstructor() throws LabException {
        int[] arr = {1, 2, 3, 4, 5};
    ...
    @Test
    public void testGetArray() throws LabException {
        int[] arr = {1, 2, 3};
        ArrayOnJava ops = new ArrayOnJava(arr);
